...
const sepoliaAccounts = PRIVATE_KEY ? [PRIVATE_KEY] : { mnemonic: MNEMONIC, path: "m/44'/60'/0'/0/" as const, count: 10 };
...
const config: HardhatUserConfig = {
  ...
  etherscan: {
    // Etherscan API v2: one key for all supported chains (incl. Sepolia).
